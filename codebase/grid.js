...
exports.getMaxArrayNumber = function (array) {
    if (!array.length)
        return;
...
exports.getMinArrayNumber = function (array) {
    if (!array.length)
        return;
...
var html_1 = __webpack_require__(2);
var ts_message_1 = __webpack_require__(73);
...
function showTooltip(_a) {
    ...
    if (!node)
        return;
    ts_message_1.tooltip(value.toString(), { css: "dhx_grid_tooltip", node: node, htmlEnable: htmlEnable });
}
...
exports.getMaxRowHeight = function (row, cols, config) {
    ...
    for (var _i = 0, _c = Object.entries(row); _i < _c.length; _i++) {
        ...
        if (definedColumns[key] &&
            ...
            if (lineBreak > 1) {
                lineBreak = core_1.getTextLines(ctx, currentValue, (_b = definedColumns[key]) === null || _b === void 0 ? void 0 : _b.width).length;
            }
            mathLineBreak.push(lineBreak);
            defaultLineBreak.push(currentValue.split("\n").length);
        }
    }
    var maxRows = Math.max(core_1.getMaxArrayNumber(defaultLineBreak), core_1.getMaxArrayNumber(mathLineBreak));
    canvas.remove();
...
var View = /** @class */ (function () {
    function View(_container, config) {
        var _a;
        this.config = config || {};
        this._uid = (_a = this.config.rootId) !== null && _a !== void 0 ? _a : core_1.uid();
    }
...
function getRenderConfig(obj, data, wrapperSizes) {
    ...
    return __assign(__assign({}, config), { data: data, columns: config.columns, scroll: obj._scroll, $positions: positions, headerHeight: config.$headerLevel * config.headerRowHeight, footerHeight: config.$footerLevel * config.footerRowHeight, firstColId: filteredColumns[0] && filteredColumns[0].id, events: obj.events, _events: obj._events, filteredColumns: filteredColumns,
...
function getGridData(renderConfig, shifts) {
    ...
    var resizedLine;
    if ($resizing) {
        var colIndex = core_1.findIndex(filteredColumns, function (col) { return col.id === $resizing; });
        var firstCellLeft = main_1.getTotalWidth(filteredColumns.slice(0, colIndex)) + filteredColumns[colIndex].$width;
...
var drivers_1 = __webpack_require__(32);
...
function isOnlyPermanentFilters(filters) {
    if (!filters || core_1.isEmptyObj(filters))
        return false;
...
function getCells(conf) {
    ...
    return data.map(function (row, index) {
        ...
        return dom_1.el(".dhx_grid-row", __assign({ style: {
...
function getSpans(config, mode) {
    ...
    var _loop_1 = function (i) {
        ...
        var colIndex = core_1.findIndex(filteredColumns, function (item) { return "" + item.id === "" + col; });
        ...
        var content = void 0;
        if (core_1.isDefined(spanText)) {
            content = spanText.toString();
        }
        else {
            content = currRow[col] === undefined ? "" : data_1.toFormat(currRow[col], currCol.type, currCol.format);
        }
        ...
        var htmlEnable = main_1.isHtmlEnable(config, currCol);
        content =
        ...
        if (config.$renderFrom === "bottomFixedRows" || isFixedColsByBottomSplit) {
            ...
            top_1 = main_1.getTotalHeight(rows.slice(0, rowIndex)) - (mode ? 0 : 1);
        }
        var left = 0;
        if (config.$renderFrom === "rightFixedCols") {
            ...
            left =
                colIndex < colIndexStartSplit
                    ? -main_1.getTotalWidth(filteredColumns.slice(colIndex, colIndexStartSplit))
                    : main_1.getTotalWidth(filteredColumns.slice(colIndexStartSplit, colIndex));
        }
        else {
        ...
        var colspanWithLastCol = colIndex + cells_1.getReducedColspan(columns, col, spanWidth) === filteredColumns.length;
        ...
        css += currCol.align ? " dhx_align-" + currCol.align : " dhx_" + spanType + "-cell";
        ...
        var rColIndex = core_1.findIndex(columns, function (item) { return item.id === col; });
        var width = spanWidth > 1 ? cells_1.getWidth(columns, spanWidth, rColIndex) : currCol.$width;
        var height = void 0;
        if (spanHeight > 1) {
        ...
        if (isEditable) {
            ...
            if (config.$renderFrom === "render" ||
                ...
                if (!allFixedByRow) {
                    var headerHeight = config.$headerLevel * config.headerRowHeight;
                    var footerHeight = config.$footerLevel * config.footerRowHeight;
                    var topFixedHeight = main_1.getTotalHeight(fixedRows.top);
                    var bottomFixedHeight = main_1.getTotalHeight(fixedRows.bottom);
                    var bodyHeight = $scrollBarWidth.yState
                        ? $height - headerHeight - footerHeight - $scrollBarWidth.x - render_1.BORDERS
                        : config.$totalHeight;
                ...
                if (config.$renderFrom === "render") {
                    ...
                    if (fixedColumns.left.find(function (i) { return i.id === col; })) {
                        left = scroll_1.left + main_1.getTotalWidth(fixedColumns.left.slice(0, colIndex));
                        if (!allFixedByCol) {
                            var minWidth = main_1.getTotalWidth(fixedColumns.left.slice(colIndex, leftSplit));
                            width = width - scroll_1.left > minWidth ? width - scroll_1.left : minWidth;
                        }
                    }
                    if (fixedRows.top.find(function (i) { return i.id === row; })) {
                        top_1 = scroll_1.top + main_1.getTotalHeight(fixedRows.top.slice(0, rowIndex));
                        if (!allFixedByRow) {
                    ...
                    if (fixedColumns.right.find(function (col) {
                        ...
                        var minWidth = i_2
                            ? main_1.getTotalWidth(fixedColumns.right.slice(0, -i_2))
                            : main_1.getTotalWidth(fixedColumns.right);
                        var widthBeforeFixed = main_1.getTotalWidth(filteredColumns.slice(colIndex, totalLength - rightSplit));
                        left =
                    ...
                    if (fixedRows.bottom.find(function (row) {
                        ...
                        var minHeight = i_3
                            ? main_1.getTotalHeight(fixedRows.bottom.slice(0, -i_3))
...
function normalizeSpan(span, config) {
    ...
    var $type = core_1.isDefined(span.text) ? "string" : columns[colIndexStart].type;
...
var render_1 = __webpack_require__(9);
var date_1 = __webpack_require__(13);
var content_1 = __webpack_require__(105);
var columnsResizer_1 = __webpack_require__(109);
var keys_1 = __webpack_require__(110);
...
var Grid = /** @class */ (function (_super) {
    ...
    function Grid(container, config) {
        ...
        var showCellTooltip = function (row, column, node) {
            ...
            if (row && column && main_1.isTooltip(_this.config, column)) {
                ...
                if (column.editorType === "combobox" || column.editorType === "select") {
                    var option = data_1.getEditorOptions(column, row).find(function (item) {
                        var _a;
                    ...
                    if (values_1 === null || values_1 === void 0 ? void 0 : values_1.length) {
                        var options = data_1.getEditorOptions(column, row).filter(function (item) {
                ...
                var value_1 = data_1.toFormat(editorOption || row[column.id], column.type, column.format);
                ...
                checkIsExistValue() &&
                    main_1.showTooltip({ value: value_1, node: node, htmlEnable: main_1.isHtmlEnable(_this.config, column) });
            }
        };
        var showContentTooltip = function (event, type) {
            ...
            if (!main_1.isContentTooltip(_this.config, column, cell, type)) {
                return;
            }
            ...
            var value = isContentFunc
                ? (_b = _this.content[cell.content]) === null || _b === void 0 ? void 0 : _b.toHtml(column, _this.config) : cell === null || cell === void 0 ? void 0 : cell.text;
            ...
            if (value === null || value === void 0 ? void 0 : value.toString().length) {
                main_1.showTooltip({ value: value, node: node, htmlEnable: main_1.isHtmlEnable(_this.config, column) });
            }
        };
        _this._htmlEvents = {
            ...
            onmouseover: {
                ...
                ".dhx_span-cell:not(.dhx_grid-header-cell)": function (e) {
                    ...
                    if (row && span && main_1.isTooltip(_this.config, span)) {
                        ...
                        value && main_1.showTooltip({ value: value, node: node, htmlEnable: true });
                    }
                },
        ...
        return {
            ...
            height: (span === null || span === void 0 ? void 0 : span.rowspan) ? cells_1.getHeight(rows, span.rowspan, rowInd)
                : rows[rowInd]
                    ? rows[rowInd].$height
                    : 0,
            width: (span === null || span === void 0 ? void 0 : span.colspan) ? cells_1.getWidth(this.config.columns, span.colspan, core_1.findIndex(this.config.columns, function (item) { return item.id === span.column; }))
                : columns[colInd]
    ...
    Grid.prototype.editCell = function (rowId, colId, editorType) {
        ...
        if (!editorType) {
            ...
            if (core_1.isDefined(span === null || span === void 0 ? void 0 : span.text)) {
        ...
        return dom_1.create({
            render: function (vm, obj) {
                return _this._destructed
                    ? dom_1.el("div")
                    : render_1.render(vm, obj, _this._htmlEvents, _this.selection, _this._uid);
            },
    ...
    Grid.prototype._setEventHandlers = function () {
        ...
        this.data.events.on(ts_data_1.DataEvents.load, function () {
            ...
            if (_this.config.data instanceof ts_data_1.DataCollection) {
                dom_1.awaitRedraw().then(function () { return _this._normalizeSpans(); });
            }
            else {
        ...
        this.data.events.on(ts_data_1.DataEvents.change, function (id, status, obj) {
            ...
            if (status === "sort") {
                ...
                if (core_1.isId(id) && status === "remove") {
        ...
        this.data.events.on(ts_data_1.DataEvents.filter, function (filters) {
            ...
            if (!filters || ts_data_1.isOnlyPermanentFilters(filters)) {
        ...
        this.data.events.on(ts_data_1.DataEvents.removeAll, function () {
            ...
            if (!core_1.isEmptyObj(_this._activeFilters)) {
        ...
        this.events.on(types_1.GridEvents.cellClick, function (row, col, e) {
        ...
        this.events.on(types_1.GridEvents.afterEditEnd, function (value, eRow, eCol) {
            ...
            if (core_1.isDefined(span === null || span === void 0 ? void 0 : span.text) && value !== undefined) {
    ...
    Grid.prototype._checkFilters = function (reset) {
        ...
        if (core_1.isEmptyObj(this._activeFilters)) {
            if (reset) {
        ...
        this.config.columns.forEach(function (col) {
            col.header.forEach(function (cell) {
                ...
                if (cell.content && (cell.content === "selectFilter" || cell.content === "comboFilter")) {
                    ...
                    var filterParams = (_a = _this._activeFilters) === null || _a === void 0 ? void 0 : _a[col.id];
                    if (sync && !multi && filterParams) {
                        col.$uniqueData = [filterParams.match];
                    }
                    else if (!sync || (sync && !multi)) {
                        var unique = data_1.getUnique(_this._filterData, col.id, multi);
                        var options_2 = data_1.getEditorOptions(col);
                        ...
                        unique =
                            col.type !== "string"
                                ? Array.from(new Set(unique.map(function (val) { return data_1.toFormat(val, col.type, col.format); })))
                                : unique;
            ...
            if (data) {
                for (var _i = 0, _f = Object.entries(data); _i < _f.length; _i++) {
                    ...
                    columnsWidth = Object.assign(columnsWidth, (_b = {},
                        _b[key] = +value + (main_1.isSortable(this.config, this.getColumn(key)) ? 36 : 16),
                        _b));
                }
            }
        }
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for (var k = 0; k < ((_b = data[i]) === null || _b === void 0 ? void 0 : _b[type].length); k++) {
                ...
                if ((_d = (_c = data[i]) === null || _c === void 0 ? void 0 : _c[type][k]) === null || _d === void 0 ? void 0 : _d.text) {
                    ...
                    var content = (_j = this.content) === null || _j === void 0 ? void 0 : _j[(_l = (_k = data[i]) === null || _k === void 0 ? void 0 : _k[type][k]) === null || _l === void 0 ? void 0 : _l.content];
                    if (typeof content.calculate === "function") {
                        rowData[data[i].id] =
                            (content === null || content === void 0 ? void 0 : content.toHtml(this.getColumn(data[i].id), this.config)) || "";
                    }
                    else {
                        rowData[data[i].id] = "";
                    }
            ...
            for (var j = 0; j < row.length; j++) {
                for (var _i = 0, _m = Object.entries(row[j]); _i < _m.length; _i++) {
                    var _o = _m[_i], key = _o[0], value = _o[1];
            ...
            didMount: function () {
                ...
                if (_this._canDataParse(true)) {
                    if (!_this._container) {
                        ...
                        var parentSizes = render_1.getElementSizes(parentNode);
                        var scrollView = (_a = _this.scrollView) === null || _a === void 0 ? void 0 : _a.config.enable;
                        render_1.applyAutoWidth(_this.config, parentSizes, true, false, scrollView);
                    }
                    _this.data.parse(_this.config.data);
                }
            },
            ...
            if (mark) {
                if (typeof mark === "function") {
                    ...
                    _this._setMarks(col, function (el, c) {
                        ...
                        var min = core_1.getMinArrayNumber(data);
                        var max = core_1.getMaxArrayNumber(data);
    ...
    Grid.prototype._normalizeSpans = function () {
        var _this = this;
        var _a;
        this.config.spans = (_a = this.config.spans) === null || _a === void 0 ? void 0 : _a.map(function (span) { return Cells_1.normalizeSpan(span, _this.config); });
    };
    Grid.prototype._autoScroll = function (mode) {
        var _a, _b, _c;
        var elem = ((_a = this.scrollView) === null || _a === void 0 ? void 0 : _a.config.enable) ? (_b = this.getRootNode()) === null || _b === void 0 ? void 0 : _b.querySelector(".scroll-view") : (_c = this.getRootNode()) === null || _c === void 0 ? void 0 : _c.querySelector(".dhx_grid-body");
        if (!elem)
            return;
        var timer = null;
...
var DataCollection = /** @class */ (function () {
    ...
    DataCollection.prototype.update = function (id, newItem, silent) {
        ...
        if (item) {
            ...
            if (core_1.isId(newItem.id) && id !== newItem.id) {
    ...
    DataCollection.prototype.getIndex = function (id) {
        if (!core_1.isId(id) || !core_1.isDefined(this._pull[id])) {
            return -1;
        }
        return core_1.findIndex(this._order, function (item) { return item && item.id.toString() === id.toString(); });
    };
    ...
    DataCollection.prototype.filter = function (rule, config, silent) {
        ...
        if (rule && !(config === null || config === void 0 ? void 0 : config.$restore)) {
            id = (config === null || config === void 0 ? void 0 : config.id) || core_1.uid();
            this._filters[id] = { rule: rule, config: config || {} };
        }
        if (rule && typeof rule !== "function") {
            if (core_1.isDefined(rule.by)) {
        ...
        if (!silent) {
            ...
            this.events.fire(types_1.DataEvents.filter, [core_1.isEmptyObj(filters) ? null : filters]);
        }
        return id;
    };
    DataCollection.prototype.resetFilter = function (config, silent) {
        ...
        return core_1.isEmptyObj(this._getPureFilters(this._filters));
    };
    DataCollection.prototype.getFilters = function (config) {
        ...
        return core_1.isEmptyObj(pureFilters) ? null : pureFilters;
    };
    DataCollection.prototype.getRawFilters = function (config) {
        ...
        return core_1.isEmptyObj(filters) ? null : filters;
    };
    ...
    DataCollection.prototype._getRuleCallback = function (rule) {
        if (!core_1.isDefined(rule.by) || !core_1.isDefined(rule.match))
            return;
        return rule.compare
...
Object.defineProperty(exports, "__esModule", { value: true });
var JsonDriver_1 = __webpack_require__(33);
...
var view_1 = __webpack_require__(8);
var types_1 = __webpack_require__(26);
var helpers_1 = __webpack_require__(87);
var events_1 = __webpack_require__(4);
var ts_grid_1 = __webpack_require__(35);
...
var Cell = /** @class */ (function (_super) {
    ...
    Cell.prototype.toVDOM = function (nodes) {
        ...
        var cell = dom_1.el("div", __assign(__assign((_a = { _key: this._uid, _ref: this._uid }, _a["aria-label"] = this.config.id ? "tab-content-" + this.config.id : null, _a["data-cell-id"] = (_b = this.config.id) !== null && _b !== void 0 ? _b : null, _a), handlers), { class: this._getCss(false) +
            ...
            isFieldset
                ? dom_1.el("fieldset.dhx_form-fieldset", {
                    class: (this.config.$disabled && " dhx_form-fieldset--disabled") || "",
                    style: stylePadding,
                    disabled: this.config.$disabled,
                }, [
                    dom_1.el("legend.dhx_form-fieldset-legend", {
                        class: "dhx_form-fieldset-legend--" + (this.config.labelAlignment ||
                            "left"),
                    }, this.config.label),
    ...
    Cell.prototype._initHandlers = function () {
        ...
        var resizeStart = function (event) {
            ...
            blockOpts.margin = helpers_1.getMarginSize(_this.getParent().config);
...
var events_1 = __webpack_require__(4);
var html_1 = __webpack_require__(2);
var keycodes_1 = __webpack_require__(98);
var view_1 = __webpack_require__(8);
var ts_data_1 = __webpack_require__(6);
var ts_layout_1 = __webpack_require__(24);
var ts_list_1 = __webpack_require__(45);
var ts_popup_1 = __webpack_require__(28);
var keyListener_1 = __webpack_require__(102);
...
var Combobox = /** @class */ (function (_super) {
                    ...
                    dom_1.el("ul.dhx_combobox-input-list", __spreadArrays(this._drawSelectedItems(), [
                        dom_1.el("li.dhx_combobox-input-list__item.dhx_combobox-input-list__item--input", [
                            (isInputTemplate || isInputImageOrIcon) && item
                                ? dom_1.el("div.dhx_combobox-input__template", {
                                    ".innerHTML": isInputTemplate
                                        ? this.config.template(item)
                                        : null,
                                }, isInputImageOrIcon ? [exports.$template(item)] : null)
                                : null,
                            dom_1.el("input.dhx_combobox-input", {
                                style: {
                                    opacity: isInputTemplate || isInputImageOrIcon ? 0 : null,
                                },
    ...
    Combobox.prototype._drawSelectedItems = function () {
        ...
        return this.list.selection.getId().map(function (id) {
            ...
            return dom_1.el("li.dhx_combobox-input-list__item.dhx_combobox-tag", { "data-dhx-id": id }, __spreadArrays((imageOrIcon || !_this.config.template
                ? [imageOrIcon, dom_1.el("span.dhx_combobox-tag__value", _this._getItemText(item))]
                : [
                    dom_1.el("span.dhx_combobox-tag__template", {
...
var editors_1 = __webpack_require__(99);
exports.MOVE_UP = 1;
exports.MOVE_DOWN = 2;
var List = /** @class */ (function (_super) {
    ...
    function List(node, config) {
        ...
        _this.events.on(types_1.SelectionEvents.afterSelect, function (id) {
            if (core_1.isId(id) && _this.config.selection)
                _this.setFocus(id);
            _this.paint();
        });
...
var Selection = /** @class */ (function () {
    function Selection(config, data, events) {
        ...
        this._data.events.on(ts_data_1.DataEvents.afterRemove, function (obj) {
            ...
            if (core_1.isId(_this._nextSelection)) {
...
function getFixedColsHeader(renderConfig, layout, mode) {
    ...
    var frozenHeaderCols = FixedRows_1.getFixedRows(__assign(__assign({}, renderConfig), { currentColumns: columns, $positions: __assign(__assign({}, $positions), { xStart: 0, xEnd: isRightSplit ? rightSplit : leftSplit }), scroll: { top: 0, left: 0 }, filteredColumns: columns }), __assign(__assign({}, layout), { name: "header", position: "top", shifts: { x: 0, y: 0 } }), mode);
...
function getFixedCols(renderConfig, layout, mode, source) {
    ...
    var fixedCols = Cells_1.getCells(__assign(__assign({}, renderConfig), { filteredColumns: columns, $renderFrom: renderFrom, $positions: __assign(__assign({}, $positions), { xStart: 0, xEnd: isRightSplit ? rightSplit : leftSplit }) }));
    ...
    var frozenFooterSpans = FixedRows_1.getFixedSpans(__assign(__assign({}, renderConfig), { filteredColumns: columns }), __assign(__assign({}, layout), { name: "footer", position: "bottom" }), mode);
    var getRowAriaAttrs = function (count) { return ({
        role: "rowgroup",
        "aria-rowcount": count,
    }); };
...
function getRows(config, rowsConfig) {
    ...
    return rows.map(function (row, j) {
        return dom_1.el(".dhx_" + rowName + "-row", __assign({ style: {
            ...
            if (cell.content) {
                return dom_1.el(".dhx_grid-" + rowName + "-cell.dhx_grid-custom-content-cell", __assign(__assign({ class: css.trim(), "data-dhx-id": column.id, "data-dhx-text-id": cell.id, _key: column.id, style: {
                        width: column.$width,
            ...
            return dom_1.el(".dhx_grid-" + rowName + "-cell", __assign(__assign({ class: css.trim(), "data-dhx-id": column.id, "data-dhx-text-id": cell.id, _key: column.id, style: {
                    width: column.$width,
                    height: rowName === "footer" ? rowHeight + BORDERS / 2 + "px" : rowHeight + "px",
    ...
    return rows.map(function (row, i) {
        ...
        return dom_1.el(".dhx_span-row", {
            ...
            if (mode === types_1.Split.right && cellIdx === 0 && !cell.colspan) {
                var rows_1 = main_1.transpose(columns.map(function (col) { return col[rowsConfig.name] || []; }));
                    ...
                    if (currCell.colspan > 1) {
                        ...
                        for (var k = 0; k < spanCols.length; k++) {
                            ...
                            spanPartByRightSplit = {
                                cell: currCell,
                                col: columns[j],
                                widthBefore: cells_1.getWidth(spanCols, k, 0),
            ...
            var reducedColspan = cell.colspan && cells_1.getReducedColspan(columns, col.id, cell.colspan);
            ...
            if (nCell.rowspan) {
                spanHeight = spanHeight * nCell.rowspan - 1;
            }
            if (rowsConfig.name === "footer" && nCell.rowspan > 1) {
                spanHeight++;
            }
            var sortIconVisible = main_1.isSortable(config, nCol) &&
                nCell.rowspan &&
                nCell.text &&
                rowsConfig.name !== "footer" &&
                nCell.headerSort !== false;
            var sortIconCss = "dxi dxi-sort-variant dhx_grid-sort-icon";
            if (config.sortBy && "" + nCol.id === config.sortBy && !nCell.content) {
                sortIconCss += " dhx_grid-sort-icon--" + (config.sortDir || "asc");
            }
            var cellAlign = nCol.align
                ? "dhx_align-" + nCol.align
                : (nCol.type === "number" || nCol.type === "percent" || nCol.type === "date") &&
                    !nCell.colspan
                    ? "dhx_align-right"
                    : "dhx_align-left";
            var css = "dhx_grid-header-cell " + isFirstCol + " " + isLastCol + " " + (nCell.rowspan ? "dhx_span-cell__rowspan" : "") + " " + (nCell.align ? "dhx_align-" + nCell.align : cellAlign) + " " + (nCell.css ? nCell.css : "");
            if (sortIconVisible) {
                css += " dhx_grid-header-cell--sortable";
            }
            if (!nCell.content) {
                if (nCell.align) {
                    css += " dhx_grid-header-cell--align_" + nCell.align + " ";
                }
                else {
                    css += " dhx_grid-header-cell--" + (nCol.type === "number" || nCol.type === "percent" || nCol.type === "date"
                        ? "align_right"
                        : "align_left") + " ";
                }
            }
            ...
            return nCell.colspan || nCell.rowspan
                ? dom_1.el(".dhx_span-cell", __assign({ style: {
                        width: cells_1.getWidth(columns, nCell.colspan, core_1.findIndex(columns, function (item) { return item.id === nCol.id; })),
                        height: spanHeight,
                        left: leftShift -
                            nCol.$width -
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(0);
var datacollection_1 = __webpack_require__(31);
var dataproxy_1 = __webpack_require__(14);
var helpers_1 = __webpack_require__(11);
var types_1 = __webpack_require__(10);
...
var TreeCollection = /** @class */ (function (_super) {
    ...
    TreeCollection.prototype._applyFilter = function (rule, config) {
        var _this = this;
        if (!rule || (typeof rule !== "function" && core_1.isEmptyObj(rule)))
            return;
        if (!this._initOrder) {
            this._initOrder = this._order;
        }
...
var html_1 = __webpack_require__(2);
var ts_grid_1 = __webpack_require__(35);
var CollectionStore_1 = __webpack_require__(112);
var types_1 = __webpack_require__(10);
var helpers_1 = __webpack_require__(11);
var core_1 = __webpack_require__(0);
...
var Exporter = /** @class */ (function () {
    ...
    Exporter.prototype._rawExport = function (config, mode, view) {
        ...
        var viewConfig = __assign(__assign({}, view.config), { width: width,
            height: height, columns: viewColumns, data: view.data.getRawData(), keyNavigation: false, selection: false, resizable: false });
        var $view = new view.constructor(viewContainer, core_1.getCloneObject(viewConfig));
        dom_1.awaitRedraw()
            .then(function () {
            var _a;
...
var TextAreaEditor_1 = __webpack_require__(104);
var lastEditor = {
    cell: {
        row: null,
        col: null,
...
Object.defineProperty(exports, "__esModule", { value: true });
var Layout_1 = __webpack_require__(25);
var ProCell_1 = __webpack_require__(89);
...
var core_1 = __webpack_require__(0);
var dom_1 = __webpack_require__(1);
var ScrollView_1 = __webpack_require__(27);
var Cell_1 = __webpack_require__(38);
...
Object.defineProperty(exports, "__esModule", { value: true });
var InputEditor_1 = __webpack_require__(100);
...
var ProList = /** @class */ (function (_super) {
    ...
    ProList.prototype.scrollTo = function (id) {
        ...
        var listEl = ((_a = this.scrollView) === null || _a === void 0 ? void 0 : _a.config.enable) ? (_b = this.getRootNode()) === null || _b === void 0 ? void 0 : _b.querySelector(".scroll-view") : this.getRootNode();
        this._scrollTo(id, listEl);
    };
...
var data_1 = __webpack_require__(7);
var core_1 = __webpack_require__(0);
var ComboFilter_1 = __webpack_require__(106);
var SelectFilter_1 = __webpack_require__(107);
var InputFilter_1 = __webpack_require__(108);
    ...
    return {
        inputFilter: {
            ...
            match: function (_a) {
                ...
                if (!core_1.isDefined(val))
                    return false;
                var values = [];
                values.push(data_1.toFormat(val, col.type, col.format));
                if (col.format) {
                    var i = col.format.lastIndexOf("#");
                    if (i > 0) {
                        values.push(data_1.toFormat(val, col.type, col.format.slice(i)));
                    }
                }
                var res = "";
                ...
                return values.some(function (value) { return new RegExp("" + res, "i").test(value); });
            },
            value: {},
        },
        selectFilter: {
...
var ComboFilter = /** @class */ (function () {
    ...
    ComboFilter.prototype.initHandlers = function () {
        ...
        this.config.events.on(ts_data_1.DataEvents.load, function () {
            _this._setData();
        });
        ...
        this.config.events.on(types_1.GridEvents.filterChange, function (value) {
            _this.events.fire(types_1.HeaderFilterEvent.change, [value]);
        });
        ...
        this.config.events.on(types_1.GridEvents.afterRowShow, function () {
            _this._setData(true);
        });
...
var SelectFilter = /** @class */ (function () {
    ...
    SelectFilter.prototype.toHTML = function () {
        var _this = this;
        return dom_1.el("label.dhx_grid-filter__label.dxi.dxi-menu-down", { _ref: this.column.id + "_filter" }, [
...
var InputFilter = /** @class */ (function () {
    ...
    InputFilter.prototype.toHTML = function () {
        return dom_1.el("div.dhx_grid-filter__label.dxi.dxi-magnify", { "aria-label": "Type to search", _ref: this.column.id + "_filter" }, [
            dom_1.el("label", {
                style: {
                    display: "none",
                },
...
var ProGrid = /** @class */ (function (_super) {
    ...
    ProGrid.prototype._createView = function () {
        ...
        return dom_1.create({
            render: function (vm, obj) {
                return _this._destructed
                    ? dom_1.el("div")
                    : render_1.proRender(vm, obj, _this._htmlEvents, _this.selection, _this._uid);
            },
            hooks: this._initHooks(),
        }, this);
    };
    ...
    ProGrid.prototype._dragStart = function (event) {
        if (this.config.dragMode &&
            ...
            var moveIds = [itemId];
            if (this.config.multiselection) {
                moveIds = __spreadArrays(moveIds, this.selection.getCells().map(function (i) { return i.row.id; }));
                if (moveIds.length > 1) {
...
var Selection = /** @class */ (function () {
    function Selection(config, data, events) {
        ...
        this._data.events.on(types_2.DataEvents.change, function () {
            if (core_1.isId(_this._selected)) {
